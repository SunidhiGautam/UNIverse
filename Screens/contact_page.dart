...
void main() {
  runApp(MaterialApp(
    ...
    routes: {
      '/home': (context) => const HomePage(), // Replace HomeScreen with your home page widget
    },
  ));
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            const SizedBox(height: 20), // Spacing between the image and the text content
      ...
      bottomNavigationBar: BottomNavigationBar(
        selectedItemColor: const Color(0xFFFA743C),
        ...
        items: [
          BottomNavigationBarItem(
            icon: IconButton(
              ...
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const HomePage())); // Make sure '/home' route is defined
              },
            ),
            label: "Home",
          ),
